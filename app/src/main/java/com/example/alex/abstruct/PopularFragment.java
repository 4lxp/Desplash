...
public class PopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String url = "https://api.unsplash.com/photos?per_page=20&page=1&order_by=popular&client_id=42af43eb53971d07987caea0f6474d8592f3633d1f810a92ba3468f36fa44a25";
        ...
        recyclerView.addOnScrollListener(new EndlessRecyclerOnScrollListener(layoutManager) {
            ...
            public void onLoadMore(int current_page) {
                ...
                String url = "https://api.unsplash.com/photos?per_page=20&page="+String.valueOf(current_page)+"&order_by=Popular&client_id=42af43eb53971d07987caea0f6474d8592f3633d1f810a92ba3468f36fa44a25";
    ...
    private void setRecyclerViewAdapter(){
        ...
        recyclerViewAdapter = new RecyclerViewAdapter(getContext(), imageArrayList);
